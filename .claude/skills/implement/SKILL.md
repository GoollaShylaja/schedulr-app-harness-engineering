...
2. **Implement** the change following the stated pattern reference (constructor injection,
   record DTOs, `@Transactional` at the service layer, typed exceptions — see `CLAUDE.md`).
